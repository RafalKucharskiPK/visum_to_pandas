...
#paths
PATH = "/Users/rafal/Google Drive/data/MOMM_net.net"
OUTPATH = "/Users/rafal/Google Drive/data/visum/"
IS_TABLE_FLAG = False
    ...
    for line in net:
        ...
        if line == '\n':
            ...
            if len(data) > 0:
                ...
                pd.DataFrame(data, columns=cols).to_csv(OUTPATH+tablename+".csv")
